export default {
    ...
    props: [
        ...
        },
        {
            ...
            require: false,
            description:
                "Función que se ejecuta cuando el valor en JSON cambia.",
        },
        {
        ...
        },
        {
            ...
            require: false,
            description:
                "Función que se ejecuta cuando el valor en formato string cambia.",
        },
        {
            ...
            require: false,
            description:
                "Función que convierte el valor de formato string a JSON.",
        },
        {
            ...
            require: false,
            description:
                "Función que convierte el valor de JSON a formato string.",
        },
    ],
    returns: [
        {
            ...
            type: "T",
            description:
                "Valor calculado en formato JSON, basado en el valor string o JSON pasado como argumento.",
        },
        {
            id: "defaultValue",
            type: "T",
            description:
                "Valor predeterminado en formato JSON, basado en el valor string o JSON pasado como argumento.",
        },
        {
            id: "onChange",
            type: "(e: T) => void",
            description:
                "Función para actualizar el valor JSON y sincronizar su representación en formato string.",
        },
    ],
    useExample: [
        {
