export default {
    "id": "usePagination",
    "name": "usePagination",
    "description": "El hook usePagination permite gestionar y manipular datos de paginación en una aplicación. Utiliza el hook useData internamente para manejar el estado de los datos de paginación y proporciona métodos para actualizar y cambiar estos datos.",
    "props": [
        {
            "id": "name",
            "type": "string",
            "require": false,
            "description": "Nombre único para diferenciar distintas instancias de paginación."
        },
        {
            "id": "onChage",
            "type": "(data: PaginationDataProps) => void",
            "require": false,
            "description": "Función que se ejecuta cuando los datos de paginación cambian."
        }
    ],
    "returns": [
        {
        ...
        },
        {
            "id": "setData",
            "type": "(data: PaginationDataProps) => void",
            "description": "Función para establecer los datos de paginación directamente."
        },
        {
            "id": "onChangeData",
            "type": "(data: PaginationDataProps) => void",
        ...
        },
        {
            ...
            "description": "Función para actualizar los datos de paginación usando una función de callback."
        }
    ],
    "useExample": [
        {
