export default {
    id: "useData",
    name: "useData",
    description: "Hook personalizado para administrar y validar datos con múltiples opciones para manejar cambios, envío y estados de error.",
    props: [
        {
            id: "defaultData",
            type: "T",
        ...
        },
        {
            ...
            require: false,
            description: "Un objeto que contiene varias opciones de configuración para el hook."
        }
    ],
    extras: [
        {
            ...
            description: "Opciones para personalizar el comportamiento del hook.",
            tableItems: [
                {
                    Nombre: "data",
                    Descripcion: "Datos opcionales para sobrescribir los datos predeterminados.",

                },
                {
                    Nombre: "refreshDataIfChangeDefaultData",
                    Descripcion: "Opciones para refrescar los datos si los datos predeterminados cambian.",

                },
                {
                    Nombre: "onChangeDataAfter",
                    Descripcion: "Función de callback que se llama después de que los datos cambian.",

                },
                {
                    Nombre: "onDeleteDataAfter",
                    Descripcion: "Función de callback que se llama después de que los datos se eliminan.",

                },
                {
                    Nombre: "onMemo",
                    Descripcion: "Función de memoización para transformar los datos antes de pasarlos como valor memorizado.",

                },
                {
                    Nombre: "validator",
                    Descripcion: "Instancia de clase validadora para validar los datos de data.",

                },
                {
                    Nombre: "validatorMemo",
                    Descripcion: "Instancia de clase validadora para validar los datos de dataMemo.",
                ...
                },
                {
                    ...
                    Descripcion: "Función de callback para manejar errores de análisis.",

                },
                {
                    Nombre: "onAfterSubmitDataError",
                    Descripcion: "Función de callback para manejar errores después de enviar los datos.",

                },
                {
                    Nombre: "afterSubmitDataSetIsChangeFalse",
                    Descripcion: "Determinar si se cambia el valor de isChange despues del terminar onSubmitData.",

                },
                {
                    Nombre: "onSubmitDataMemo",
                    Descripcion: "Función de callback para enviar los datos de dataMemo.",
                ...
                },
                {
                    ...
                    Descripcion: "Función de callback para manejar errores de análisis de dataMemo.",

                },
                {
                    Nombre: "onAfterSubmitDataMemoError",
                    Descripcion: "Función de callback para manejar errores después de enviar los datos de dataMemo.",

                },
                {
                    Nombre: "afterSubmitDataMemoSetIsChangeFalse",
                    Descripcion: "Determinar si se cambia el valor de isChange despues del terminar onSubmitDataMemo.",

                },
                {
                    Nombre: "autoOnValidate",
                    Descripcion: "Indicador para validar automáticamente los datos.",
                },
                {
                    Nombre: "env_log",
        ...
        },
        {
            ...
            description: "Opciones para refrescar los datos cuando los datos predeterminados cambian.",
            tableItems: [
                {
                    Nombre: "active",
                    Descripcion: "Indicador para indicar si los datos deben actualizarse cuando cambian los datos predeterminados.",
                    Default: "false"
                },
                {
                    Nombre: "useReloadKeyData",
                    Descripcion: "Indicador para recargar la clave de los datos cuando cambian los datos predeterminados.",
                    Default: "false"
                }
            ]
        },
            ...
            tableItems: [
                {
                    ...
                    Descripcion: "Indicador para controlar si se debe usar el callback `onChangeDataAfter` al configurar los datos.",
                    Default: "true"
                },
                {
                    Nombre: "useSetIsChange",
                    Descripcion: "Indicador para controlar si el estado `isChange` debe configurarse en `true` después de configurar los datos.",
                    Default: "true"
                }
            ]
        }
    ...
    returns: [
        ...
        },
        {
            id: "isChange",
            type: "boolean",
            description: "Valor que determina si la informacion guardada en data ha cambiado."
        },
        {
            id: "setData",
        ...
        },
        {
            ...
            description: "Función para actualizar los datos usando una función."
        },
        {
            id: "dataMemo",
            type: "M",
            description: "Datos guardados en useData y transformados con la funcion onMemo proporcionada."
        },
        {
            id: "setIsChange",
            type: "(f: boolean) => void",
        ...
        },
        {
            id: "onRestart",
            type: "function",
            description: "Función para restablecer los datos a su valor default."
        },
        {
            id: "onConcatData",
            type: "(v: Partial<T> | Array<T>) => void",
            description: "Función para concatenar nuevos datos a los datos actuales."
        },
        {
            id: "keyData",
            type: "number",
            description: "Valor de key asignado a data, que cambia con algunos acciones."
        },
        {
            id: "setKeyData",
            type: "(f: number) => void",
        ...
        },
        {
            id: "onReloadKeyData",
            type: "function",
            description: "Función para actualizar la variable keyData a un numero generado del Time."
        },
        {
            id: "validator",
        ...
        },
        {
            id: "onValidateData",
            type: "function",
            description: "Funcion para ejecutar validator a data y guardar el resultado en isValidData."
        },
        {
            id: "onValidateDataMemo",
            type: "function",
            description: "Funcion para ejecutar validatorMemo a dataMemo y guardar el resultado en isValidDataMemo."
        },
        {
            id: "onSubmitData",
        ...
        },
        {
            id: "loaderSubmit",
            type: "boolean",
            description: "Valor que determina si esta procesando el envio de data con onSubmitData."
        },
        {
            id: "loaderSubmitMemo",
            type: "boolean",
            description: "Valor que determina si esta procesando el envio de dataMemo con onSubmitDataMemo."
        },
        {
            id: "resultSubmitData",
            type: "RT",
        ...
        },
        {
            id: "dataError",
            type: "ET",
            description: "Valor del error al ejecutar onSubmitData en caso que ocurra un error."
        },
        {
            id: "dataErrorMemo",
            type: "EM",
            description: "Valor del error al ejecutar onSubmitDataMemo en caso que ocurra un error."
        },
        {
        ...
        },
        {
            ...
            description: "Funcion para modificar el valor de resultSubmitDataMemo."
        },
