    ...
    returns: [
        {
            ...
            type: "object",
            description:
                "El enrutador de Next.js si está disponible, de lo contrario, el enrutador de `useWindowRouter`.",
        },
    ],
    useExample: [
        {
            ...
            tableItems: [
                {
                    Nombre: "env_log",
                    Descripcion:
                        "Registra mensajes en la consola cuando el enrutador de Next.js no está disponible.",
                    Default: false,
                },
            ],
        },
