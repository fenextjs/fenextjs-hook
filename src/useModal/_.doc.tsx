export default {
    ...
    props: [
        ...
        },
        {
            ...
            require: false,
            description:
                "Clave utilizada para almacenar el estado activo del modal en el almacenamiento local.",
        },
        {
            ...
            require: false,
            description:
                "Si está activo, permite controlar el estado del modal a través del almacenamiento local usando el último nombre almacenado.",
            defaultValue: "false",
        },
        {
            ...
            require: false,
            description:
                "Permite controlar el estado del modal usando todos los nombres almacenados en el almacenamiento local.",
            defaultValue: "false",
        },
        {
            id: "active",
            ...
            require: false,
            description:
                "Estado de activación del modal pasado como propiedad.",
        },
        {
            id: "defaultActive",
            type: "boolean",
        ...
        },
        {
            ...
            require: false,
            description:
                "Función que se ejecuta al cambiar el estado del modal.",
        },
        {
            id: "disabled",
            type: "boolean",
            require: false,
            description:
                "Deshabilita las acciones sobre el modal si está establecido en `true`.",
            defaultValue: "false",
        },
    ],
    returns: [
        {
            ...
            type: "boolean",
            description:
                "Estado actual del modal, considerando el valor almacenado y el estado de recarga.",
        },
        {
            id: "activeNameLast",
            type: "boolean",
            description:
                "Indica si el nombre del modal es el último en la lista del almacenamiento local.",
        },
        {
            id: "activeName",
            type: "boolean",
            description:
                "Indica si el nombre del modal está presente en la lista del almacenamiento local.",
        },
        {
            id: "listNamesLocalStorage",
            type: "string[]",
            description:
                "Lista de nombres de modales almacenados en el almacenamiento local.",
        },
        {
            id: "onChange",
            type: "(d: boolean) => void",
